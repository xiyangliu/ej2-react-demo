...
class App extends React.Component {
  ...
  handleSave() {
    ...
    localStorage.setItem("ej2Diagram", saveData);
  }
  ...
  render() {
    return (
      <div className="ui equal height stretched grid internally celled">
        ...
        <div className="ui three wide column">
          <div>
            <Button variant="primary" size="large" onClick={this.handleSave}>
              Save
            </Button>
            <Button variant="primary" size="large" onClick={this.handleExport}>
              Export
            </Button>
            <Button variant="primary" size="large" onClick={this.handleImport}>
              Load
            </Button>
          </div>
        </div>
